...
//                if (locale[i].equals(Locale.CHINA)) {
    ...
    static {
        ...
        specialHanzi.put("67e5", '\u6e23');//查->宅

        specialHanzi.put("89e3", '\u8c22');//解->谢

        specialHanzi.put("533a", '\u6b27');//区->欧

        specialHanzi.put("5c09", '\u4e8e');//尉->于

        specialHanzi.put("53ec", '\u5c11');//召->少

        specialHanzi.put("6437", '\u5ad6');//朴->嫖
