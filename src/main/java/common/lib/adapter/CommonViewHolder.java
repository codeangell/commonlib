...
public class CommonViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommonViewHolder setText(int viewId, CharSequence text) {
        ...
        tv.setText(text);
//        try {
//            EmojiUtil.handlerEmojiText(tv, text, mContext);
//        } catch (IOException e) {
//            tv.setText(text);
//            e.printStackTrace();
//        }
    ...
    public CommonViewHolder setImageUrl(int viewId, String url) {
        ...
        ImageLoader.loadByUrl(mContext.getApplicationContext(), url, imageView);
        return this;
    }
    public CommonViewHolder setImageUrl(int viewId, String url,int failDrawableId) {
        final ImageView imageView = getView(viewId);
        ImageLoader.loadByUrl(mContext.getApplicationContext(), url, imageView, failDrawableId);
        return this;
    }
    ...
    public CommonViewHolder setInVisible(int viewId, boolean visible) {
        View view = getView(viewId);
