...
public class CycleWheelView extends ListView {
    ...
    private static final int COLOR_DIVIDER_DEFALUT = 0xff747474;
    private static final int HEIGHT_DIVIDER_DEFAULT = 2;
    private static final int COLOR_SOLID_DEFAULT = 0xff3e4043;
    private static final int COLOR_SOLID_SELET_DEFAULT = 0xff323335;
    ...
    /**
     * textSize Of Selected Label
     */
    private int mLabelSelectSize = DensityUtil.sp2px(getContext(), 6);

    /**
     * Color Of Unselected Label
     */
    private int mLabelSize = DensityUtil.sp2px(getContext(), 5);
    /**
     * te Of Unselected Label
     */
    ...
    private void init() {
        ...
        setOnScrollListener(new OnScrollListener() {
            ...
            public void onScrollStateChanged(AbsListView view, int scrollState) {
                ...
                if (onCycleWheelScrollListerer != null) {
                    onCycleWheelScrollListerer.onScrollStateChanged(view, scrollState);
                }
            }
    ...
    private OnCycleWheelScrollListener onCycleWheelScrollListerer;

    public void setOnCycleWheelScrollListerer(OnCycleWheelScrollListener onCycleWheelScrollListerer) {
        this.onCycleWheelScrollListerer = onCycleWheelScrollListerer;
    }

    public interface OnCycleWheelScrollListener {
    ...
    private void refreshItems() {
        ...
        if (mItemSelectedListener != null) {
            mItemSelectedListener.onItemSelected(getSelection(), getSelectLabel(), getId());
        }
...
//                labelTv.setTextSize(mLabelSelectSize);
                itemView.setAlpha(1f);
            } else {
                labelTv.setTextColor(mLabelColor);
//                labelTv.setTextSize(mLabelSize);
     ...
     */
    public void setLabelSelectColor(int labelSelectColor, int textSize) {
        this.mLabelSelectColor = labelSelectColor;
        this.mLabelSelectSize = DensityUtil.sp2px(getContext(), textSize);
        resetItems(getFirstVisiblePosition(), mCurrentPositon, mWheelSize / 2);
    }
    ...
    public interface WheelItemSelectedListener {
         void onItemSelected(int position, String label, int id);
    }
