 ...
 * Date: 2015/11/28
 * Time: 14:57
 * Introduction: 用于创建不同形状的ImageView.
 */
public abstract class PathImageView extends android.support.v7.widget.AppCompatImageView {
    private static final String TAG = PathImageView.class.getSimpleName();
